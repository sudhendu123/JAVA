...
public class JIntegerBucketSorter {
	...
	public static void main(String[] args) {
        ...
        JIntegerBucketSorter sorter=new JIntegerBucketSorter();
        List<Integer> actual = sorter.sort(unsorted);	
	}
	
	public JIntegerBucketSorter(Comparator<Integer> comparator) {
        this.comparator = comparator;
    }

	public JIntegerBucketSorter() {
