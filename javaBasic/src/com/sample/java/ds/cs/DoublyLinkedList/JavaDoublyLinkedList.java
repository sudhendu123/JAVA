...
public class JavaDoublyLinkedList<E> extends AbstractSequentialList<E>
 ...
 */
public JavaDoublyLinkedList(Collection<? extends E> c) {
    this();
    addAll(c);
}
...
// Deque operations
	...
	@SuppressWarnings("unchecked")
	private JavaDoublyLinkedList<E> superClone() {
		try {
			return (JavaDoublyLinkedList<E>) super.clone();
	...
	/**
	 * Returns a shallow copy of this {@code JavaLinkedList}. (The elements themselves
	 * are not cloned.)
	 *
	 * @return a shallow copy of this {@code JavaLinkedList} instance
	 */
	public Object clone() {
		JavaDoublyLinkedList<E> clone = superClone();
	...
	/**
	 * Saves the state of this {@code JavaLinkedList} instance to a stream (that is,
	 * serializes it).
	 *
	...
	/**
	 * Reconstitutes this {@code JavaLinkedList} instance from a stream (that is,
	 * deserializes it).
	 */
	@SuppressWarnings("unchecked")
	...
	static final class LLSpliterator<E> implements Spliterator<E> {
		...
		final JavaDoublyLinkedList<E> list; // null OK unless traversed
		Node<E> current; // current node; null until initialized
		int est; // size estimate; -1 until first needed
		int expectedModCount; // initialized when est set
		int batch; // batch size for splits

		LLSpliterator(JavaDoublyLinkedList<E> list, int est, int expectedModCount) {
			this.list = list;
			this.est = est;
		...
		final int getEst() {
			...
			final JavaDoublyLinkedList<E> lst;
			if ((s = est) < 0) {
				if ((lst = list) == null)
					s = est = 0;
				else {
