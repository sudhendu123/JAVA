package com.sample.java.lambadas.ch1;
...
public class Lambdas1 {
	...
	public static void main(String[] args) {
		...
		friends.stream().map(String::toUpperCase).filter(startsWithLetter.apply("N")).forEach(System.out::println);
	...
	private static void pickName(final List<String> names, final String startingLetter) {
		...
		System.out.println(
				String.format("A name stating with %s: %s", startingLetter, foundName.orElse("No name found")));
	}
}
